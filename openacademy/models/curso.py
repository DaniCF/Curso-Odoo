...
class openacademy_session(models.Model):
    ...
    course_tipe = fields.Selection([('presencial','Presencial'), ('enlinea','En linea')], string='Tipo de curso')
    course_cost = fields.Float(string='Precio')
